				...
				{activeTab === "overview" ? (
					<>
						...
						<div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
							...
							{/* Resume command */}
							{task.sessionId && task.branch && (
								<div className="flex items-center gap-2">
									<code className="flex-1 text-code bg-surface-alt px-3 py-2 rounded font-mono text-caption select-all truncate">
										claude --resume {task.branch}
									</code>
									<button
										type="button"
